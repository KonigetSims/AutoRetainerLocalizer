...
public sealed unsafe class UserInterface : NeoUIEntry
{
    ...
    public override NuiBuilder Builder => new NuiBuilder()
        ...
        .Section("用户界面")
        .Checkbox("匿名化雇员", () => ref C.NoNames, "雇员名称将在常规UI元素中被隐藏（调试菜单和插件日志中仍可见）。启用此选项后，不同插件界面中的角色和雇员编号可能不一致")
        ...
        .Checkbox("不警告同一目录运行多个游戏", () => ref C.No2ndInstanceNotify, "这将使AutoRetainer在第二个游戏客户端中自动跳过加载，除非在主客户端中禁用此选项")
